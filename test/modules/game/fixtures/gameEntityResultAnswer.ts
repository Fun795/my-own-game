import { gameEntityFromEsb } from "./gameEntityFromEsb";
...
export const gameEntityResultCorrectAnswer: Game = _.cloneDeep(gameEntityFromEsb);
...
export const gameEntityResultNotCorrectAnswer: Game = _.cloneDeep(gameEntityFromEsb);
...
export const gameEntityResultFinishAnswer: Game = _.cloneDeep(gameEntityFromEsb);
